...
> **Neo4j differential suite 310/325** (0 failed, 15 skipped — 100% of the
> executable cases, against a live Neo4j 2025.09.0);
> **openCypher TCK conformance 60.9%** (2356 passed / 1441 failed / 71 skipped of
...
> `cargo +nightly test --workspace --no-fail-fast` reports **5851 passed / 0 failed**
> (the three long-standing "known flakes" were the shared test catalog crossing the
> 64-label `label_bits` cap, fixed by isolating those tests' catalogs).
...
- **Neo4j Compatibility**: 310/325 on the Neo4j differential suite (curated queries; 0 failed, 15 skipped); openCypher TCK conformance 60.9% (strict spec, 2356/3868 scenarios; see docs/compatibility/OPENCYPHER_TCK_REPORT.md)
