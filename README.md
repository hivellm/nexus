...
- [`docs/compatibility/OPENCYPHER_TCK_REPORT.md`](docs/compatibility/OPENCYPHER_TCK_REPORT.md) — **60.9%** openCypher TCK conformance (2355/3868), regenerated by the harness and therefore the authority over any figure quoted by hand.
...
- ✅ **310/325** Neo4j diff suite (2025.09.0) — 0 failed, 15 skipped.
- 📊 **60.9%** openCypher TCK conformance (2355/3868) — the strict-spec metric, not the same thing as the diff suite.
