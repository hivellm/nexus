## 1. Implementation
- [ ] 1.1 Re-measure the RC18 bucket after the truncation task and record the real remaining count before editing
- [ ] 1.2 Name an un-aliased projection item by the verbatim source text of its expression, parentheses included
- [ ] 1.3 Guarantee an aliased item is always named by its alias
- [ ] 1.4 Confirm the hidden ORDER BY carry-column never reaches the client
