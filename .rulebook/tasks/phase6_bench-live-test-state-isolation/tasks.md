...
- [x] 4.1 Update or create documentation covering the implementation — crate README's "Integration tests" section, `docs/benchmarks/README.md` Integration-tests block
