...
| Status | Task | Progress | Description |
|--------|------|----------|-------------|
| ⬚ | phase6_fulltext-analyzer-catalogue | 0/5 | fulltext analyzer catalogue |
| ⬚ | phase6_fulltext-benchmarks | 0/5 | fulltext benchmarks |
| ⬚ | phase6_fulltext-wal-integration | 0/5 | fulltext wal integration |
| 🔄 | phase6_opencypher-fulltext-search | 51/51 | opencypher fulltext search |
