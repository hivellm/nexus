...
| Status | Task | Progress | Description |
|--------|------|----------|-------------|
| ⬚ | phase6_bench-live-test-state-isolation | 12/13 | bench live test state isolation |
| ⬚ | phase6_bench-scenario-expansion | 0/45 | bench scenario expansion |
| ⬚ | phase6_nexus-create-bound-var-duplication | 0/5 | nexus create bound var duplication |
| ⬚ | phase6_nexus-delete-executor-bug | 10/12 | nexus delete executor bug |
