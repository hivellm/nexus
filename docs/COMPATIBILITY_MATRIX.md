...
|---------------------|---------|-------------------------------------------------------|
| Workspace crate     | 2.0.0  | `Cargo.toml` `[workspace.package].version`            |
| `nexus-server`      | 2.0.0  | Docker image + binary; mirrors workspace              |
| `nexus-cli`         | 2.0.0  | mirrors workspace                                     |
| `nexus-protocol`    | 2.0.0  | RPC + HTTP wire format                                |
| Rust SDK            | 2.0.0  | `nexus-sdk` on crates.io                              |
| Python SDK          | 2.0.0  | `hivehub-nexus-sdk` on PyPI                           |
| TypeScript SDK      | 2.0.0  | `@hivehub/nexus-sdk` on npm                           |
| Go SDK              | 2.0.0  | `github.com/hivellm/nexus-go`                         |
| C# SDK              | 2.0.0  | `Nexus.SDK` on NuGet                                  |
| PHP SDK             | 2.0.0  | `hivellm/nexus-php` on Packagist                      |
...
| Date       | Version | Status     |
|------------|---------|------------|
| 2026-04-30 | 2.0.0   | current    |
| 2026-04-28 | 1.15.0  | superseded |
