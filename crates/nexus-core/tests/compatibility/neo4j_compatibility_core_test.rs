//! Neo4j Compatibility Tests — core multi-label / UNION / relationship coverage.
//!
//! Split from `neo4j_compatibility_test.rs` (tier-3 oversized-module refactor).
//! This binary contains the tests that exercise the full fixture graph built by
//! `setup_test_data`: multiple labels, UNION queries, bidirectional traversal,
//! and relationship property access.
//!
