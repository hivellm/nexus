//! Core aggregation operators: `execute_aggregate` and the
//! projection-aware variant `execute_aggregate_with_projections`.
...
use super::super::super::types::{Aggregation, Operator, ProjectionItem, ResultSet, Row};
    ...
    pub(in crate::executor) fn execute_aggregate_with_projections(
        ...
        for row in rows_to_process {
            ...
            let group_key = match serde_json::to_string(&group_key_values) {
                Ok(s) => s,
                Err(e) => {
                    super::super::super::serde_metrics::record_propagated_failure(
                        super::super::super::serde_metrics::SerdeFallbackSite::AggregateGroupKey,
                    );
