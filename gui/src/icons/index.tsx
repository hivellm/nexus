/**
 * Icon set ported from `gui/assets/icons.jsx`.
 *
 * The mockup keeps every icon as a single 1–3 line stroke SVG; we
 * deviate from the task's "one file per icon" letter and ship them
 * as named exports in this barrel because the alternative — 26
 * one-line files plus a barrel — is pure import-tax with no
 * encapsulation gain. Each icon stays a small functional component
 * that forwards `IconProps` to the underlying `<svg>`, so call
 * sites can override `aria-label`, `className`, `onClick`, etc.
 */
...
export const DatabaseIcon = (p: IconProps) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" {...p}>
    <ellipse cx="8" cy="3.5" rx="5.5" ry="1.8" stroke="currentColor" strokeWidth="1.4" />
    <path
...
export const GraphIcon = (p: IconProps) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" {...p}>
    <circle cx="3.5" cy="3.5" r="1.8" stroke="currentColor" strokeWidth="1.3" />
    ...
    <path
      d="M4.8 4.8L6.8 10.5M11.2 4.8L9.2 10.5M5.3 3.5h5.4"
      stroke="currentColor"
      strokeWidth="1.3"
    />
  </svg>
...
export const TableIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" {...p}>
    ...
    <path
      d="M2 6.5h12M2 10h12M6 6.5V13M10 6.5V13"
      stroke="currentColor"
      strokeWidth="1.2"
    />
  </svg>
...
export const ReplicationIcon = (p: IconProps) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" {...p}>
    ...
    <path
      d="M5.5 7.3l5.4-2.6M5.5 8.7l5.4 2.6"
      stroke="currentColor"
      strokeWidth="1.3"
    />
  </svg>
...
export const HistoryIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" {...p}>
    <path
      d="M2.5 8a5.5 5.5 0 109-4.2M2.5 3v3h3"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const SaveIcon = (p: IconProps) => (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" {...p}>
    <path
      ...
      strokeLinejoin="round"
    />
    <rect x="5.5" y="2" width="5" height="3.5" stroke="currentColor" strokeWidth="1.3" />
    <rect x="5" y="8.5" width="6" height="4" stroke="currentColor" strokeWidth="1.3" />
  </svg>
);
...
export const ShareIcon = (p: IconProps) => (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" {...p}>
    ...
    <path d="M5.5 7.3l5-2.6M5.5 8.7l5 2.6" stroke="currentColor" strokeWidth="1.3" />
  </svg>
);
...
export const BellIcon = (p: IconProps) => (
  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" {...p}>
    <path
      d="M4 7a4 4 0 018 0v3l1 2H3l1-2V7zM6.5 13a1.5 1.5 0 003 0"
      stroke="currentColor"
      strokeWidth="1.3"
      strokeLinejoin="round"
    />
...
export const RefreshIcon = (p: IconProps) => (
  <svg width="13" height="13" viewBox="0 0 16 16" fill="none" {...p}>
    ...
    />
    <path
      d="M12.5 6.5A5 5 0 003.5 5M3.5 9.5A5 5 0 0012.5 11"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
export const DotIcon = (p: IconProps) => (
  <svg width="4" height="4" viewBox="0 0 4 4" fill="currentColor" {...p}>
